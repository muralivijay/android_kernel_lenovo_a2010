...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	printk("gain = %d ,reg[0x366a]= %d, reg_gain = 0x%x\n ", gain, ChangeFlag, reg_gain);
...
{
	printk("OV5670_Sensor_Init_2lane E\n");
...
{
	printk(" OV5670PreviewSetting_2lane enter\n");
...
{
	printk("OV5670CaptureSetting_2lane enter! currefps:%d\n",currefps);
