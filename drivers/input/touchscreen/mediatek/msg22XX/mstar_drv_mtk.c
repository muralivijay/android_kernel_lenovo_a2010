...
//extern struct ctp_alsps_priv *cust_ctp_alsps_obj;
...
/* The I2C device list is used for matching I2C device and I2C device driver. */
 ...
 static unsigned short force[] = { 0, 0x26, I2C_CLIENT_END, I2C_CLIENT_END };
...
*/
    ...
    tpd_button_setting(4, (void*)g_TpVirtualKey, (void*)g_TpVirtualKeyDimLocal); //MAX_KEY_NUM
#endif //CONFIG_ENABLE_REPORT_KEY_WITH_COORDINATE  
#endif //CONFIG_TP_HAVE_KEY  
...
static void tpd_resume(struct device *h)
{
    ...
    /*Begin ersen.shang 20151230 for gsensor cts verfier test*/
	isTpInSuspend = 0;
	/*End   ersen.shang 20151230 for gsensor cts verfier test*/
