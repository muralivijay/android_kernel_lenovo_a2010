...
//static struct kobj_attribute packet_attr = __ATTR(packet, S_IWUGO, DrvMainKObjectPacketShow, DrvMainKObjectPacketStore);
static struct kobj_attribute packet_attr = {
	.attr = {
		 .name = "packet",
		 .mode = S_IRWXUGO,
		 },
	.show = &DrvMainKObjectPacketShow,
	.store = &DrvMainKObjectPacketStore,
};
